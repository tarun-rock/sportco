  ...
  var options = {
      ...
      setProgressBar = function ($el, score) {
          ...
          if (score < options.scores[0]) {
              progressbar.children().addClass("bg-danger").removeClass("bg-warning").removeClass("bg-success");
              ...
              progressbar.children().addClass("bg-warning").removeClass("bg-danger").removeClass("bg-success");
              ...
              progressbar.children().addClass("bg-success").removeClass("bg-warning").removeClass("bg-danger");
      ...
      progressWidget = function () {
          return '<div class="progress"><div class="bar progress-bar"></div></div>';
      },
