			...
			function DynamicTabs() {
				...
				if ($horizontalContainer.parent('.dynamic-tabs-container').length === 0) {
					...
					$horizontalContainer.after(
						"<div class='nav navbar-nav navbar-right dropdown tabs-dropdown d-none d-sm-block d-md-none'><a href='#' class='btn btn-default dropdown-toggle' data-toggle='dropdown'><i class='fas fa-bars'></i></a><ul class='dropdown-menu' role='menu'><div class='dropdown-header visible-xs'><p class='count'>Tabs</p><button type='button' class='close' data-dismiss='dropdown'><span aria-hidden='true'>&times;</span></button><div class='divider visible-xs'></div></div></ul></div>"
					);
				}
