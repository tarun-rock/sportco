                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" required>
                                        <option value="0">Via Currency Only</option>
                                        <option value="1">Via Token Only</option>
                                        <option value="2">Via Token Also</option>
                                    </select>
                                </div>
                            </div>

                            <div id="tokenInput" class="col-md-4 @if(empty(old('token')) && empty($edit->token)) d-none @endif">
                                <div class="form-group">
                                    <label>Tokens</label>
